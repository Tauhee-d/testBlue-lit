      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            {/* 1st item */}
            <Link to="/service" className="btn-sm text-white bg-purple-600 hover:bg-purple-700 ml-3">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Service Overview</h4>
              <p className="text-lg text-gray-400 text-center">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat.</p>
            </div>
            </Link>

            {/* 2nd item */}
            <Link to="/offeringsAndApporach" className="btn-sm text-white bg-purple-600 hover:bg-purple-700 ml-3">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Offerings & Approach</h4>
              <p className="text-lg text-gray-400 text-center">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat.</p>
            </div>
            </Link>
            ...
            {/* 3rd item */}
            <Link to="/development" className="btn-sm text-white bg-purple-600 hover:bg-purple-700 ml-3">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-lg text-gray-400 text-center"> We take pride in delivering sustainable business solutions and not
              merely provide software developed in the latest technology.</p>
            </div>
            </Link>

            {/* 4th item */}
            <Link to="/staffAugmentation" className="btn-sm text-white bg-purple-600 hover:bg-purple-700 ml-3">
